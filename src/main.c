...
int main(void)
{
    ...
    //Interrupt Signal  normaly generated by : Ctrl + C instead of crashing immediately, the program exits gracefully.
    //Resources may not be released properly. hence it needed. 
