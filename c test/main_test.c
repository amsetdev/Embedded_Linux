...
#define MONITORING_INTERVAL 30   /* seconds between read cycles */
#define MAX_RETRIES         2
#define POINT_DELAY_US      10000 /* 10 ms between register reads */
#define MAX_POINTS          2000
#define LABEL_MAX           64
#define UNIT_MAX            16
#define PAYLOAD_MAX         131072 /* 128 KB JSON buffer */
...
{
    LOG_INFO("Connecting to %s @ %d baud (slave %d)...",
    ...
    modbus_set_response_timeout(mb_ctx, timeout.tv_sec, timeout.tv_usec);
    ...
    LOG_INFO("Connected to Modbus device");
    return 1;
}
...
int main(void)
{
    ...
    printf("\n================================================================================\n");
    printf("  MODBUS RTU READER — HiveMQ Cloud MQTT\n");
    printf("================================================================================\n");
